...
const Form=(props)=>{
    ...
    const inputClickHandler=(event)=>{
        ...
        props.greetFunction(variableName);
    }
    ...
    return(
        <React.Fragment>
            ...
            <button onClick={inputClickHandler} type="submit">SUBMIT</button>
...
//                 <button onClick={this.inputClickHandler} type="submit">SUBMIT</button>
//                 </form>
//             </React.Fragment>
//         )
//     }
